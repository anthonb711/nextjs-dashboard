...
export default async function Page () {
  ...
  //The commented code above was written by me. The tutorial show a better way which is below
  const {
    numberOfInvoices,
    numberOfCustomers,
    totalPaidInvoices,
  ...
  return (
    <main>
      ...
      <div className='mt-6 grid-cols-1 gap-6 md:grid-cols-4 lg:frid-cols-8'>
